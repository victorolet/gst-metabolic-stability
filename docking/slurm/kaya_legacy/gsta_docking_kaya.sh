...
#############################################
# Define paths
EXECUTABLE=$SLURM_SUBMIT_DIR/Vina_rigid_A.pl
...
if [ ! -f "$SLURM_SUBMIT_DIR/config_A1.txt" ]; then
    echo "ERROR: config_A1.txt not found"
    exit 1
fi
...
cp "$SLURM_SUBMIT_DIR/config_A1.txt" "$SCRATCH/"
