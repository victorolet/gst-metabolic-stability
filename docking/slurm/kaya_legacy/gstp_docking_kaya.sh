...
#############################################
# Define paths
EXECUTABLE=$SLURM_SUBMIT_DIR/Vina_rigid_P.pl
...
if [ ! -f "$SLURM_SUBMIT_DIR/config_P1.txt" ]; then
    echo "ERROR: config_P1.txt not found"
    exit 1
fi
...
cp "$SLURM_SUBMIT_DIR/config_P1.txt" "$SCRATCH/"
